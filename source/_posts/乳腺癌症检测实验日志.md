...
## 尝试将传统方法数据增强程度调小，并去掉y轴翻转，修复负的box坐标问题，代码分支：best_v1_0_no_flip_y
|fold num|fold|froc|
:------:|:------:|:------:|
|2|0|86.10|
|2|1|90.00|
...
# 假阳性减少
使用
|base model|lr|lr decay|fold|mean_fpr|
|:------:|:------:|:------:|:------:|:------:|
|inception_resnet_v2|1e-3|No|0|0.6262|
|inception_resnet_v2|1e-3|No|1|0.5932|
|inception_resnet_v2|1e-4|No|0|0.5990|
|inception_resnet_v2|1e-4|No|1||
